 ...
 */
package br.gov.sp.fazenda.processors.sql;
...
import static br.gov.sp.fazenda.processors.util.JdbcCommon.AvroConversionOptions;
import static br.gov.sp.fazenda.processors.util.JdbcCommon.ResultSetRowCallback;
